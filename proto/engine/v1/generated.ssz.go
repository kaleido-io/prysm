...
// Hash: 277d5c74211e72570b3e9729d39b3863e9f30eb850cd57b7bf46abee165e09db
package enginev1
...
func (e *ExecutionPayloadElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(e.ConsolidationRequests) * 24
...
func (e *ExecutionPayloadElectra) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o19:]
		num, err := ssz.DivideInt2(len(buf), 24, 1)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = e.ConsolidationRequests[ii].UnmarshalSSZ(buf[ii*24 : (ii+1)*24]); err != nil {
				return err
			}
		}
	}
...
func (e *ExecutionPayloadElectra) SizeSSZ() (size int) {
	...
	// Field (19) 'ConsolidationRequests'
	size += len(e.ConsolidationRequests) * 24
...
func (c *ConsolidationRequest) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'SourceAddress'
	dst = ssz.MarshalUint64(dst, c.SourceAddress)

	// Field (1) 'SourcePubkey'
	dst = ssz.MarshalUint64(dst, c.SourcePubkey)

	// Field (2) 'TargetPubkey'
	dst = ssz.MarshalUint64(dst, c.TargetPubkey)
...
func (c *ConsolidationRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'SourceAddress'
	c.SourceAddress = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'SourcePubkey'
	c.SourcePubkey = ssz.UnmarshallUint64(buf[8:16])

	// Field (2) 'TargetPubkey'
	c.TargetPubkey = ssz.UnmarshallUint64(buf[16:24])
...
func (c *ConsolidationRequest) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'SourceAddress'
	hh.PutUint64(c.SourceAddress)

	// Field (1) 'SourcePubkey'
	hh.PutUint64(c.SourcePubkey)

	// Field (2) 'TargetPubkey'
	hh.PutUint64(c.TargetPubkey)
